CREATE DATABASE  IF NOT EXISTS `control_raspi` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `control_raspi`;
-- MySQL dump 10.13  Distrib 5.5.59, for debian-linux-gnu (x86_64)
--
-- Host: 127.0.0.1    Database: control_raspi
-- ------------------------------------------------------
...
-- Dump completed on 2018-04-17 19:44:33
